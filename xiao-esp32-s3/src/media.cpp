...
// 24-tap Hamming-windowed sinc, fc=7kHz, gain L=3 baked in, quantized Q15.
// Split into 3 phases x 8 taps: y[3i+p] = sum_t kFir[3t+p] * x[i-t], 8 MACs
// per output sample. Replaces linear interp (still audibly raspy — first-order
// imaging residue). Generated by scripts/gen_fir_taps.py; phase DC sums 32714/
// 32746/32714 (~unity).
static const int16_t kInterpFir[24] = {
    -195, -56, 319, 830, 761, -691, -3078, -4013, -471, 8439, 19681, 27561,
    27561, 19681, 8439, -471, -4013, -3078, -691, 761, 830, 319, -56, -195};
